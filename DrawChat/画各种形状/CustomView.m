...
-(void)drawRect:(CGRect)rect{
    ...
    CGContextRef context = UIGraphicsGetCurrentContext();
        //写文字
    CGContextSetRGBFillColor(context, 1, 1, 0.5, 1.0);//设置填充颜色
    ...
    CGContextDrawPath(context, kCGPathStroke); //绘制路径
        //填充圆，无边框
    CGContextAddArc(context, 150, 40, 40, 0, 2*PI, 0); //添加一个圆
    CGContextDrawPath(context, kCGPathFill);//绘制填充
        //画大圆并填充颜
    UIColor*aColor = [UIColor colorWithRed:1 green:0.0 blue:0 alpha:1];
    CGContextSetFillColorWithColor(context, aColor.CGColor);//填充颜色
    CGContextSetLineWidth(context, 3.0);//线的宽度
    CGContextAddArc(context, 250, 50, 50, 0, 2*PI, 0); //添加一个圆
...
//
    ...
    sPoints[1] =CGPointMake(160, 220);//坐标2
    sPoints[2] =CGPointMake(200, 160);//坐标3
...
//    
    ...
    CGContextDrawImage(context, CGRectMake(100, 450, 100, 100), image.CGImage);//使用这个使图片上下颠倒了，参考http://blog.csdn.net/koupoo/article/details/8670024
